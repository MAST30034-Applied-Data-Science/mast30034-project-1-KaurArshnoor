...
## README 
**Please change this to your requirements**.

**Research Goal:** My research goal is to analyse tip behaviour.

**Timeline:** The timeline for the research area is October 2018 to March 2019.

To run the pipeline, please visit the `scripts` directory and run the files in order:
1. `download_data.ipynb`: This downloads the raw data into the `data/raw` directory.
